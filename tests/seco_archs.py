...
VOCAB = 97
COMMON = dict(vocab_size=VOCAB, hidden_size=64, intermediate_size=128, num_hidden_layers=4,
...
ARCHS = {
    ...
    "qwen3_next": ("qwen3_next", {
        ...
        "num_experts_per_tok": 2, "moe_intermediate_size": 32, "shared_expert_intermediate_size": 32}),
    "gemma2": ("gemma2", {"sliding_window": WINDOW}),
    "gemma3": ("gemma3_text", {"sliding_window": WINDOW, "sliding_window_pattern": 2,
                               "layer_types": ["sliding_attention", "full_attention"] * 2}),
    "lfm2": ("lfm2", {"layer_types": ["conv", "conv", "full_attention", "conv"], "conv_L_cache": 3,
                      "block_ff_dim": 128, "norm_eps": 1e-5}),
    "gpt_oss": ("gpt_oss", {"sliding_window": WINDOW, "num_local_experts": 4, "num_experts_per_tok": 2,
                            "layer_types": ["sliding_attention", "full_attention"] * 2}),
    "phi3": ("phi3", {}),
    "olmo2": ("olmo2", {}),
    "smollm3": ("smollm3", {}),
    ...
    "gpt2": ("gpt2", {}),
    # Mamba hybrids
    "bamba": ("bamba", {"attn_layer_indices": [2], "mamba_n_heads": 8, "mamba_d_head": 16, "mamba_d_state": 16,
                        "mamba_n_groups": 1, "mamba_chunk_size": 16}),
    "falcon_h1": ("falcon_h1", {"mamba_n_heads": 8, "mamba_d_head": 16, "mamba_d_ssm": 128, "mamba_d_state": 16,
                                "mamba_n_groups": 1, "mamba_chunk_size": 16}),
    "jamba": ("jamba", {"attn_layer_period": 2, "attn_layer_offset": 1, "expert_layer_period": 4,
                        "num_experts": 2, "mamba_d_state": 16, "mamba_dt_rank": 8}),
    "nemotron_h": ("nemotron_h", {"hybrid_override_pattern": "M*M-", "mamba_num_heads": 8, "mamba_head_dim": 16,
                                  "ssm_state_size": 16, "n_groups": 1, "chunk_size": 16}),
    "granitemoehybrid": ("granitemoehybrid", {"layer_types": ["mamba", "attention", "mamba", "mamba"],
                                              "mamba_n_heads": 8, "mamba_d_head": 16, "mamba_d_state": 16,
                                              "mamba_n_groups": 1, "mamba_chunk_size": 16, "num_local_experts": 2,
